...
<template>
    <div class="banner" id="banner">
        ...
        <!-- 脚贴 -->
        <div class="fork-me">
            <a class="fork-me-link" href="https://github.com/ShiinaOrez" target="_blank">
                <span class="fork-me-text">My GitHub</span>
            </a>
        </div>
        <!-- 背景层 -->
        ...
        <div data-aos="fade-in" class="desc">
            ...
            <div>
                <h1>{{banner.title || 'ShiinaOrez'}}</h1>
                <h3 class="typer white">
                    俺，
                    <vue-typer :text="banner.desc || 'ShiinaOrez'" :type-delay='200' eraseStyle='select-all'></vue-typer>
                </h3>
            </div>
        </div>
